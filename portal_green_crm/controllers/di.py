...
class CustomerPortal(CustomerPortal):
    ...
    def portal_my_dis(self, page=1, date_begin=None, date_end=None, sortby=None, **kw):
        ...
        return request.render("portal_green_crm.portal_my_dis", values)
    ...
    def portal_di_page(self, di=None, access_token=None, **kw):
        ...
        return request.render("portal_green_crm.portal_di_page", values)
    ...
    def portal_di_report(self, di_id, access_token=None, **kw):
        ...
        pdf = request.env.ref('studio_customization.documento_de_identif_1d084d06-1300-4837-87cb-2fe21db280a4').sudo().render_qweb_pdf([di_sudo.id])[0]
        pdfhttpheaders = [
